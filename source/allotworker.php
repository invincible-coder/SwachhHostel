...
<html lang="en">
<head>
  <title>Allot Worker - Worker Admin Dashboard</title>
      ...
      <div class="container-fluid">
        ...
        <?php if (isset($_SESSION['admin_logged'])) : ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <span class="alert-inner--text"><strong>Welcome to online Swachh Hostel admin portal.</strong>
              ...
              <form method="POST" autocomplete="off" action="allothandler.php">
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-control-label" for="input-requestid">Worker<span class="text-danger">*</span></label>
