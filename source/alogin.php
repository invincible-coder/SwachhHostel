    ...
    <div class="row parent-row">
      ...
      <div class="col s1 l7 hide-on-med-and-down">
        <div class="flex-v-center">
          ...
          <p class="support-text">Browse requests and complaints. <br>Allot Workers.</p>
        </div>
      </div>
      <!-- Form -->
      <div class="col s12 l5">
        <div class="center-align form-align">
          <h4>Sign In</h4>
          <p class="hide-on-large-only">Browse student requests and complaints. Allot Workers.</p>
          <div class="row">
